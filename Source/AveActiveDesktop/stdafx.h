...
#define DEBUGHOST_FILENAME L"AveEffectDebugHost.exe"
...
#ifdef DEBUG
#define AVETRACE(x) OutputDebugString(x)
#else
#define AVETRACE(x) __noop
#endif

#define USE_TIMEBOMB		FALSE
#define TIMEBOMB_DATE_YEAR	2009
...
#define AVE_ACTIVEDESKTOP_REG_KEY L"SOFTWARE\\AveApps\\AveActiveDesktop\\"